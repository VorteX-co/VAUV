...
### local_SLAM node    
Generates a series of poses and submaps by matching this generated poses with a reference scan .
#### Subscribed Topics
* /estimated_pose
...
Dealing with regenrated path from  Subnode_processing node and give the required motion profile for the control system of the AUV.
#### Subscribed Topics
...
#### Published Topics
