...
#ifndef TRAJECTORY_TRACKING_MPC__MANEUVER_NODE_HPP_
#define TRAJECTORY_TRACKING_MPC__MANEUVER_NODE_HPP_
#include <math.h>
#include <Eigen/Core>
#include <Eigen/Dense>
#include <Eigen/QR>
...
/**
 * @brief The ManeuverNode class is a ros wrapper for the maneuver MPC class
 */
...
public:
  // Constructor
  explicit ManeuverNode(const rclcpp::NodeOptions & options);
  // callbacks
...
#endif  // TRAJECTORY_TRACKING_MPC__MANEUVER_NODE_HPP_
