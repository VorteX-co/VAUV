...
#ifndef TRAJECTORY_TRACKING_MPC__MPC_HPP_
#define TRAJECTORY_TRACKING_MPC__MPC_HPP_
...
public:
  ...
  Vector6d action(Vector12d state, Vector12d desired_state, Vector6d feedforward_acc);
...
#endif  // TRAJECTORY_TRACKING_MPC__MPC_HPP_
